 ...
 * Careers page body.
 *
 * Renders the roles published in the CMS, falling back to the "no openings"
 * panel when there are none. Because it reads live content, publishing a role
 * shows up on the next page load rather than the next deploy.
 */
export default function CareerContent() {
  ...
  if (jobs.length) return <JobOpenings jobs={jobs} fallbackEmail={email} />;
    ...
    <Reveal className="mx-auto max-w-2xl">
      <div className="rounded-2xl border border-forest-100 bg-white p-10 text-center shadow-card md:p-14">
        ...
        <p className="mt-4 text-sm leading-relaxed text-forest-800/75 md:text-base">
          We do not have any vacancies at the moment. New positions will be posted on this page as
          they become available.
        </p>

        <div className="mt-9 border-t border-forest-100 pt-8">
          <p className="text-sm leading-relaxed text-forest-800/75">
            If you would still like to be considered for future roles, send your CV to <br />
            <a
              href={`mailto:${email}`}
          ...
          <Button
            href={`mailto:${email}?subject=Career%20Enquiry`}
            variant="primary"
